...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        setError("Inscription réussie mais erreur de connexion. Essaie de te connecter.");
        setLoading(false);
      } else {
        router.push("/app");
      }
      ...
      <div className="w-full max-w-sm">
        ...
        <Link href="/" className="flex items-center gap-2.5 justify-center mb-10">
          <svg width="32" height="32" viewBox="0 0 40 40" fill="none">
            ...
            <defs>
              <linearGradient id="rlg" x1="0" y1="0" x2="40" y2="40">
        ...
        <p className="text-sm text-[#5c5c6e] text-center mb-8">
          Commence gratuitement avec 5 transformations par jour
        </p>
